<template>
  <v-container>
    ...
    <v-layout v-bind="binding" style="min-height: 150px">
      <v-flex xs6>
        <v-card class="elevation-6 mr-1 ml-1 text-xs-left" style="height: 100%">
          <v-container>
            <v-layout>
              <div>
              <h2>{{ $t('location') }}</h2>
      ...
      <v-flex xs6>
        <v-card class="elevation-6 mr-1 ml-1 text-xs-left" :class="{'mt-1': !showHorizontal}" style="height: 100%">
          <v-container>
           <v-layout>
              <div>
